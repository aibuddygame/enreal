...
const CONTENT = {
    en: {
        outcomes: [
            { title: 'Tools → Strategy', desc: 'Master how AI drives revenue, cuts costs, and boosts efficiency. Evolve from operator to strategic architect.', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop' },
            { title: 'Execution → Design', desc: 'Architect AI workflows, automate reporting, and build decision-making frameworks that scale.', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=800&auto=format&fit=crop' },
            { title: 'Employee → Indispensable', desc: 'Ship a real AI MVP. Leverage results to negotiate. Become the talent your company fights to keep.', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=800&auto=format&fit=crop' }
        ],
        curriculum: [
            { phase: 'Phase 1', title: 'AI Mindset + Tool Mastery', subtitle: 'Sessions 1-4', desc: 'Master the AI tools that drive business results. Build your first AI-powered workflow.', learn: ['AI business models: revenue, cost, efficiency', 'Marketing AI automation', 'Document & report generation', 'Decision intelligence frameworks'] },
            { phase: 'Phase 2', title: 'MVP Build', subtitle: 'Sessions 5-6', desc: 'Transform ideas into working AI products. Ship your first MVP with mentor guidance.', learn: ['Rapid MVP prototyping', 'Real-world scenario simulation', '1-on-1 mentor optimization', 'Demo-day preparation'] },
            { phase: 'Phase 3', title: 'Executive Demo 🔥', subtitle: 'Session 7', desc: 'Present your MVP to real CEOs. Get feedback. Unlock career opportunities.', learn: ['C-Level presentation mastery', 'Live CEO/MD demo', 'Real-time feedback & iteration', 'Executive network building'] }
        ],
        phrases: ['7 Sessions. AI Leader.', 'Build. Ship. Scale.', 'MVP + Network = Career'],
        hero: { eyebrow: 'AI CAREER ACCELERATOR', title: 'Become Your Company\'s AI Leader in 7 Sessions', subtitle: 'Lead AI transformation. Build an MVP portfolio. Present to CEOs.', desc: 'Master AI tools. Lead transformation. Build portfolio. Present to CEOs. Get promoted.', ctaPrimary: 'Enroll Now', ctaSecondary: 'Explore Program' },
        shift: { eyebrow: '// THE PROGRAM', title: 'Build Real AI. Lead Real Change.', subtitle: 'For mid-level professionals ready to accelerate', features: [{ title: 'Ship Real Projects', desc: 'Build workplace-ready AI solutions. Not theory. Real code. Real results.' }, { title: 'Access Real CEOs', desc: 'Session 7: Demo to actual CEOs. Build relationships that advance your career.' }, { title: 'Lead Real Change', desc: 'Move from tool-user to AI strategist. Lead your team. Drive transformation.' }, { title: 'Get Real Results', desc: 'Built for professionals 30-45. Get credentials that get you promoted.' }] },
        outcomesSection: { eyebrow: '// RESULTS', title: '7 Sessions. 3 Transformations.' },
        curriculumSection: { eyebrow: '// CURRICULUM', title: 'Learn. Build. Lead.', subtitle: 'MVP Portfolio · CEO Network · Promotion Ready', learnTitle: 'What You Master' },
        allianceSection: { eyebrow: '// THE ALLIANCE', title: 'The Enreal AI Alliance', subtitle: 'Builders. Leaders. Network.', description: 'The course is your entry.<br>The Alliance is your advantage. Lifetime access to the AI ecosystem.', cta: 'Join the Alliance', pillars: [{ title: 'Executive Network', subtitle: 'CEO & VC Access', desc: 'Curated gatherings with decision-makers. VCs seeking AI tools. CEOs seeking strategies. Founders who ship.' }, { title: 'Innovation Lab', subtitle: 'R&D Sandbox', desc: 'Test AI concepts with industry veterans before you invest. Access shared playbooks, SOPs, and cutting-edge tools.' }, { title: 'Career Engine', subtitle: 'Matching & Growth', desc: 'We match you with companies seeking AI talent. You are not a user. You are the talent they compete for.' }, { title: 'Policy Edge', subtitle: 'AI for All Leaders', desc: 'Lead Hong Kong\'s AI transformation. Stay ahead of policy. Access government initiatives. Drive the future.' }] },
        forWho: { eyebrow: '// WHO IT\'S FOR', title: 'Mid-Level Professionals', subtitle: '30-45 · Report to C-Level · Ready to Lead', tags: ['Mid-Level Managers 30-45', 'Report to C-Suite', 'Company adopting AI', 'Want promotion leverage', 'Done with theory', 'Want CEO access'] },
        pricing: { eyebrow: '// ENROLL NOW 🔥', title: '7 Sessions. New Career.', subtitle: 'Your AI leadership starts here.', originalPrice: 'Others: $6,000-$13,000', price: '$2,000', spots: '10 spots only. Small cohort. Maximum impact.', features: ['7 practical sessions', 'CEO demo day', '1-on-1 project guidance', 'Lifetime Alliance access', 'Promotion credentials'], cta: 'Enroll — Become an AI Leader' },
        footer: { nav: [{ label: 'Program', id: 'program' }, { label: 'Results', id: 'outcomes' }, { label: 'Curriculum', id: 'curriculum' }, { label: 'Who', id: 'for-who' }, { label: 'Alliance', id: 'alliance' }, { label: 'Enroll', id: 'pricing' }], brandText: 'The intelligence layer for professionals entering an AI-native economy.' }
    },
    zh: {
        outcomes: [
