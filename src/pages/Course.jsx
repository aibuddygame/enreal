...
const CONTENT = {
    en: {
        ...
        allianceSection: { eyebrow: '// ALLIANCE NETWORK', title: 'The Enreal AI Alliance', subtitle: 'Where Builders Meet Leaders', description: 'Completing the course is just the beginning. Join the Alliance for lifetime access to an AI business ecosystem. We don\'t just teach you tools—we give you a seat at the table where the AI economy is being built.', cta: 'Explore Alliance Benefits', pillars: [{ title: 'Vetted Executive Network', subtitle: 'CEO & VC Access', desc: 'Unlike generic business clubs, our Alliance is built on proven capability. Regular curated gatherings with: VCs seeking de-risked AI micro-tools, CEOs looking for implementation-ready strategies, and a peer group of builders who have shipped functional AI solutions.' }, { title: 'The "De-Risked" Innovation Lab', subtitle: 'Continuous R&D Sandbox', desc: 'The Alliance serves as a continuous R&D sandbox. Pitch new AI concepts for "Pressure Testing" by industry veterans before investing capital. Access a private library of shared SOPs, prompt playbooks, and automation workflows.' }, { title: 'Strategic B2B Matching', subtitle: 'Project Placement & Credential', desc: 'We bridge AI talent and industrial demand. Active matching with firms seeking AI consulting or custom tool development. The "Founder-Member" Badge proves you aren\'t just an "AI user," but a certified AI Builder.' }, { title: '"AI+ Strategy" Policy Advocacy', subtitle: 'Policy & Resource Edge', desc: 'As Hong Kong moves toward "New Quality Productive Forces," the Alliance acts as a unified voice. Stay ahead of HKEX regulations, government AI funding (like the $100M 2026 Budget initiatives), and ethical standards. Early access to proprietary tools.' }], induction: { title: 'Your 3-Phase Induction Path', steps: [{ phase: 'Phase 1', title: 'Induction (The Course)', desc: 'Master the stack and build your first AI Micro-App' }, { phase: 'Phase 2', title: 'Validation (The Demo)', desc: 'Present your functional MVP to our Executive Panel' }, { phase: 'Phase 3', title: 'The Alliance (Lifetime)', desc: 'Join regular gatherings, VCs, and B2B matching engine' }] } },
    ...
    zh: {
        ...
        allianceSection: { eyebrow: '// 實戰聯盟', title: 'The Enreal AI Alliance', subtitle: 'Where Builders Meet Leaders', description: '完成課程只是開始——加入實戰聯盟，獲得終身進入AI商業生態系的資格。我們不只教你工具，更給你席位，讓你參與構建AI新經濟。', cta: '了解聯盟優勢', pillars: [{ title: '實戰驗證的高層人脈', subtitle: 'CEO與創投連結', desc: '與一般商業社團不同，我們的聯盟建立在實證能力之上。定期舉辦精選聚會，連結：尋求去風險AI微工具的創投、尋找可落地「數智化」策略的CEO與行業資深人士、以及同樣交付過功能性AI解決方案的創始人同儕。' }, { title: '「去風險」創新實驗室', subtitle: '持續R&D沙盒', desc: '聯盟作為持續的研究與開發沙盒。成員可向聯盟提案新AI概念，由行業資深人士進行「壓力測試」後再投入資本。獲取私人共享的SOP庫、成功提示詞手冊與自動化工作流程。' }, { title: '戰略B2B配對與職涯加速器', subtitle: '項目配對與認證', desc: '我們搭起AI人才與產業需求之間的橋樑。主動將聯盟成員與尋求AI諮詢或定製工具開發的企業配對。「創始人-成員」徽章：證明你不只是「AI用戶」，而是認證的AI Builder。' }, { title: '「AI+戰略」政策倡議', subtitle: '政策與資源前沿', desc: '隨著香港邁向「新質生產力」，聯盟作為統一聲音。掌握HKEX法規、政府AI資金（如2026年預算1億港元計劃）與道德實施標準的先機。優先獲取Enreal AI專有工具與合作夥伴折扣。' }], induction: { title: '加入聯盟的三階段路徑', steps: [{ phase: 'Phase 1', title: '入門（課程）', desc: '掌握技術棧，構建你的第一個AI微應用' }, { phase: 'Phase 2', title: '驗證（展示）', desc: '向高管評審團展示你的功能性MVP' }, { phase: 'Phase 3', title: '聯盟（終身）', desc: '加入定期聚會、創投連結與B2B配對引擎' }] } },
