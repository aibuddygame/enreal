...
const CONTENT = {
    en: {
        ...
        curriculum: [
            { phase: 'Phase 1 (Apr 27, 30, May 4, 7)', title: 'AI Mindset + Tool Mastery', subtitle: 'Lessons 1-4', desc: 'Focus: Using AI to help companies make money/save time\n\nContent: Common tools, enterprise implementation (Marketing/Operations), problem-solving frameworks\n\nOutcome: Develop your personal AI proposal', learn: ['How AI helps companies make money/save costs/improve efficiency', 'Marketing AI workflow design', 'Document and report automation', 'Data analysis and decision framework building'] },
            { phase: 'Phase 2 (May 11, 14, 18)', title: 'MVP Practice', subtitle: 'Lessons 5-7', desc: 'Focus: From "thinking" to "doing"\n\nContent: Transform proposals into MVPs, simulate scenarios, mentor-guided optimization\n\nOutcome: Complete a demonstrable real project', learn: ['Transform AI proposals into feasible MVPs', 'Simulate real enterprise scenarios', 'One-on-one mentor guidance', 'Project presentation skills'] },
            { phase: 'Phase 3 (Late May)', title: 'Executive Presentation 🔥', subtitle: 'CEO Interview', desc: 'Focus: Real "face-to-face with the boss" experience\n\nContent: Presentation methods that impress bosses, student MVP showcase, CEO/MD feedback session\n\nOutcome: Exposure opportunities, job change/partnership opportunities', learn: ['Presentation skills for C-Level reporting', 'Showcasing results in front of real CEO/MD', 'On-the-spot feedback and optimization', 'Building executive network'] }
        ],
        phrases: ['7 Lessons to Become Your Company\'s AI Lead', 'Don\'t Just Learn AI—Lead the Transformation', 'MVP Portfolio + CEO Network'],
        hero: { eyebrow: 'AI CAREER ACCELERATOR FOR MID-LEVEL PROFESSIONALS', title: '7 Lessons to Become Your Company\'s AI Lead', subtitle: '', desc: 'Don\'t just learn AI tools—learn to lead your company\'s AI transformation, build an MVP portfolio, and present to real CEOs.', ctaPrimary: 'Enroll Now', ctaSecondary: 'Explore Program' },
        shift: { eyebrow: '// LEARNING PHILOSOPHY', title: 'Don\'t Just Learn AI—Lead the Transformation', subtitle: 'An AI Career Accelerator for Mid-Level Professionals', features: [{ title: 'MVP Portfolio Building', desc: 'Complete real AI projects and build a demonstrable portfolio. Not academic exercises—workplace-ready solutions.' }, { title: 'CEO Network Access', desc: 'Lesson 7: Present your work to real CEOs/MDs. Build executive connections and unlock promotion opportunities.' }, { title: 'From Execution to Leadership', desc: 'Move from operating AI tools to designing AI strategy and leading team transformation. Become your company\'s indispensable AI lead.' }, { title: 'Career Accelerator', desc: 'Designed for professionals aged 30-45. 7 lessons to get the credentials for promotion, not generic AI knowledge.' }] },
        outcomesSection: { eyebrow: '// OUTCOMES', title: '7 Lessons: From Employee to AI Leader' },
        ...
        pricing: { eyebrow: '// LIMITED OFFER 🔥', title: '7 Lessons to Change Your Career Trajectory', subtitle: 'Invest in yourself. Become your company\'s AI lead.', originalPrice: 'Comparable courses: $6,000-$13,000', price: '$2,000', spots: 'Only 10 students · Limited spots · Small cohort ensures quality', features: ['7 practical lessons (MVP portfolio)', 'Real CEO/MD presentation (network building)', 'Personal AI project one-on-one guidance', 'Post-course CEO network community support', 'Credentials for promotion & raise'], cta: 'Enroll Now to Become an AI Leader' },
        footer: { nav: [{ label: 'Program', id: 'program' }, { label: 'Results', id: 'outcomes' }, { label: 'Curriculum', id: 'curriculum' }, { label: 'For Whom', id: 'for-who' }, { label: 'Alliance', id: 'alliance' }, { label: 'Enroll', id: 'pricing' }], brandText: 'The intelligence layer for professionals entering an AI-native economy.' }
    },
    zh: {
        outcomes: [
        ...
        shift: { eyebrow: '// 學習理念', title: 'Enreal AI 中層晉升課程', subtitle: '專為中層專業人士設計的AI職場加速器', subtitleStyle: { fontSize: 'clamp(1.5rem, 3vw, 2.5rem)', fontWeight: 700 }, features: [{ title: '職場加速器', desc: '專為30-45歲中層設計。7堂課獲得升職加薪的籌碼，而非泛泛的AI知識。' }, { title: '從執行到領導', desc: '從操作AI工具，升級到設計AI策略、帶領團隊轉型。成為公司不可或缺的AI負責人。' }, { title: 'MVP作品集', desc: '完成真實AI項目，建立可展示的作品集。不是學術練習，而是職場可用的解決方案。' }, { title: 'CEO人脈網絡', desc: '第七堂課在真實CEO/MD面前展示成果。建立高層人脈，獲得升職轉工機會。' }] },
        ...
        pricing: { eyebrow: '// 限時優惠 🔥', title: '7堂課改變你的職業軌跡', subtitle: '投資自己，成為公司AI負責人', originalPrice: '同類課程：$6,000-$13,000', price: '$2,000', spots: '只收 10 位學員 · 滿額即止 · 小班制確保質量', features: ['7堂實戰課程（MVP作品集）', '真實CEO/MD展示機會（人脈建立）', '個人AI項目一對一指導', '課後CEO人脈社群支援', '升職加薪的籌碼'], cta: '立即報名' },
