...
const CONTENT = {
    en: {
        ...
        curriculum: [
            { phase: 'Phase 1', title: 'AI Mindset + Tool Mastery', subtitle: 'Lessons 1-4', desc: 'Master the AI tools that drive business results. Build your first AI-powered workflow.', learn: ['AI business models: revenue, cost, efficiency', 'Marketing AI automation', 'Document & report generation', 'Decision intelligence frameworks'] },
            { phase: 'Phase 2', title: 'MVP Build', subtitle: 'Lessons 5-6', desc: 'Transform ideas into working AI products. Ship your first MVP with mentor guidance.', learn: ['Rapid MVP prototyping', 'Real-world scenario simulation', '1-on-1 mentor optimization', 'Demo-day preparation'] },
            { phase: 'Phase 3', title: 'Executive Demo 🔥', subtitle: 'Lesson 7', desc: 'Present your MVP to real CEOs. Get feedback. Unlock career opportunities.', learn: ['C-Level presentation mastery', 'Live CEO/MD demo', 'Real-time feedback & iteration', 'Executive network building'] }
        ],
        phrases: ['7 Lessons. AI Leader.', 'Build. Ship. Scale.', 'MVP + Network = Career'],
        hero: { eyebrow: 'AI CAREER ACCELERATOR', title: 'Become Your Company\'s AI Leader in 7 Lessons', subtitle: 'Lead AI transformation. Build an MVP portfolio. Present to CEOs.', desc: 'Master AI tools. Lead transformation. Build portfolio. Present to CEOs. Get promoted.', ctaPrimary: 'Enroll Now', ctaSecondary: 'Explore Program' },
        ...
        outcomesSection: { eyebrow: '// RESULTS', title: '7 Lessons. 3 Transformations.' },
        ...
        pricing: { eyebrow: '// ENROLL NOW 🔥', title: '7 Lessons. New Career.', subtitle: 'Your AI leadership starts here.', originalPrice: 'Others: $6,000-$13,000', price: '$2,000', spots: '10 spots only. Small cohort. Maximum impact.', features: ['7 practical lessons', 'CEO demo day', '1-on-1 project guidance', 'Lifetime Alliance access', 'Promotion credentials'], cta: 'Enroll — Become an AI Leader' },
